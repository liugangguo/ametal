...
#ifndef __AM_lpc824_BOOT_FLASH_H
#define __AM_lpc824_BOOT_FLASH_H
#include "hw/amhw_lpc82x_iap.h"
#include "am_boot.h"
#include "am_boot_flash.h"

typedef struct am_lpc824_boot_flash_devinfo {
    ...
    uint32_t  flash_page_size;      /**< \brief 页数目 */
...
} am_lpc824_boot_flash_devinfo_t;

typedef struct am_lpc824_boot_flash_dev {
    ...
    am_lpc824_boot_flash_devinfo_t *p_devinfo;      /**< \brief 设备信息结构体 */
}am_lpc824_boot_flash_dev_t;
 ...
 */
am_boot_flash_handle_t am_lpc824_boot_flash_init(am_lpc824_boot_flash_dev_t     *p_dev,
                                                 am_lpc824_boot_flash_devinfo_t *p_devinfo);


#endif /* __AM_lpc824_BOOT_FLASH_H */
