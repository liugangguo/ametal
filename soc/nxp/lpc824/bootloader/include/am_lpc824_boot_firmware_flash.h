...
#ifndef __AM_lpc824_BOOT_FIRMWARE_H
#define __AM_lpc824_BOOT_FIRMWARE_H

#include "am_boot_flash.h"
#include "am_boot_firmware.h"
typedef struct am_lpc824_boot_firmware_flash_devinfo {
...
}am_lpc824_boot_firmware_flash_devinfo_t;

typedef struct am_lpc824_boot_firmware_flash_dev {
    /**< \brief 固件存放的标准服务 */
    am_boot_firmware_serv_t           firmware_flash_serv;
    /**< \brief flash的操作句柄*/
    am_boot_flash_handle_t            flash_handle;
    /**< \brief 设备信息 */
    am_lpc824_boot_firmware_flash_devinfo_t *p_devinfo;
    /**< \brief 数据缓冲区 */
...
}am_lpc824_boot_firmware_flash_dev_t;
 ...
 */
am_boot_firmware_handle_t am_lpc824_boot_firmware_flash_init (
    am_lpc824_boot_firmware_flash_dev_t     *p_dev,
    am_lpc824_boot_firmware_flash_devinfo_t *p_devinfo,
    am_boot_flash_handle_t                   flash_handle);
 ...
 * \brief 固件flash存储解初始化
 */
void am_lpc824_boot_firmware_flash_deint(void);

#endif /* __AM_lpc824_BOOT_FIRMWARE_H */
