 ...
 * \endinternal
 */
#include <bootloader/include/am_lpc824_boot_flash.h>
#include "am_int.h"
                                     ...
                                     uint32_t  length)
{
    ...
    am_lpc824_boot_flash_dev_t *p_dev = (am_lpc824_boot_flash_dev_t *)p_drv;
                                                 ...
                                                 am_lpc824_boot_flash_devinfo_t *p_devinfo)
{
    ...
    p_dev->flash_info.page_size          = p_devinfo->flash_page_size;
