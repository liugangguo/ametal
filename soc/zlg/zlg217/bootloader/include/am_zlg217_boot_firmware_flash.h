...
#ifndef __AM_ZLG217_BOOT_FIRMWARE_H
#define __AM_ZLG217_BOOT_FIRMWARE_H
...
}am_zlg217_boot_firmware_flash_devinfo_t;

typedef struct am_zlg217_boot_firmware_flash_dev {
    /**< \brief 固件存放的标准服务 */
...
}am_zlg217_boot_firmware_flash_dev_t;
