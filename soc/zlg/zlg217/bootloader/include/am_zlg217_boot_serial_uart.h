 ...
 */
typedef struct am_zlg217_boot_serial_uart_dev {
    am_boot_serial_byte_serv_t    serial_serv;      /**< \brief 标准的 串行数据操作 服务    */
    am_uart_handle_t              uart_handle;      /**< \brief 标准的uart操作句柄  */
} am_zlg217_boot_serial_uart_dev_t;

am_boot_serial_handle_t am_zlg217_boot_serial_uart_init(am_boot_autobaud_handle_t autobaud_handle);

void am_zlg217_boot_serial_uart_deinit(void);
