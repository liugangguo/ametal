...
{
    KFT_STATUS_UNKNOWN_COMMAND      = AM_BOOT_KFT_MAKE_STATUS(KFT_STATUS_GROUP_BOOTLOADER, 0),
    KFT_STATUS_SECURITY_VIOLATION   = AM_BOOT_KFT_MAKE_STATUS(KFT_STATUS_GROUP_BOOTLOADER, 1),
    KFT_STATUS_ABORT_DATA_PHASE     = AM_BOOT_KFT_MAKE_STATUS(KFT_STATUS_GROUP_BOOTLOADER, 2),
    KFT_STATUS_PING                 = AM_BOOT_KFT_MAKE_STATUS(KFT_STATUS_GROUP_BOOTLOADER, 3),
    KFT_STATUS_NO_RESPONSE          = AM_BOOT_KFT_MAKE_STATUS(KFT_STATUS_GROUP_BOOTLOADER, 4),
    KFT_STATUS_NO_RESPONSE_EXPECTED = AM_BOOT_KFT_MAKE_STATUS(KFT_STATUS_GROUP_BOOTLOADER, 5)
};
